...
from helper.pointnet_util import PointNetSetAbstractionMsg, PointNetSetAbstraction
...
class Point_Transformer(nn.Module):
    def __init__(self, config):
        ...
        self.sa1 = PointNetSetAbstractionMsg(256, [50, 75, 100], [16, 32, 64], in_channel, [[32, 32, 64], [64, 64, 128], [64, 96, 128]])
        self.sa2 = PointNetSetAbstractionMsg(out_points, [50, 75, 100], [32, 64, 128], 320,[[32, 64, 128], [64, 64, 128], [64, 128, 253]])
        ...
        self.flatten_linear_ch = [dim_flatten, 512, 128, 2]
